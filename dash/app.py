...
def display_page(pathname):
    if pathname == f'{PATH}proxy/8050/dash-vanguard-report' or pathname == f'{PATH}proxy/8050/dash-vanguard-report/overview':
        return overview
    elif pathname == f'{PATH}proxy/8050/dash-vanguard-report/price-performance':
        return pricePerformance
    elif pathname == f'{PATH}proxy/8050/dash-vanguard-report/portfolio-management':
        return portfolioManagement
    elif pathname == f'{PATH}proxy/8050/dash-vanguard-report/fees':
        return feesMins
    elif pathname == f'{PATH}proxy/8050/dash-vanguard-report/distributions':
        return distributions
    elif pathname == f'{PATH}proxy/8050/dash-vanguard-report/news-and-reviews':
        return newsReviews
    elif pathname == f'{PATH}proxy/8050/dash-vanguard-report/full-view':
